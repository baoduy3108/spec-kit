...
const WORDS = {
  vi: {
    ...
    legend: 'kéo thước để dò · ◀ ▶ từng nấc · đếm tiếng trong 2 cụm = 2 chữ số · GHI SỔ',
    again: 'ĐÊM SAU',

    'tip.first': 'Ở đâu đó trên thước có một người đang phát. Tìm họ.',
    'tip.grammar': 'Người phát thành CỤM: nhiều tiếng dính liền, cách đều nhau. Máy chỉ kêu lẻ, thưa thớt.',
    'tip.count': 'Đếm số tiếng trong mỗi cụm: cụm 1 là chữ số đầu, cụm 2 là chữ số sau.',
    'tip.meaning': 'Ví dụ 4 tiếng — nghỉ — 7 tiếng = 47. Đêm mai họ chuyển sang vạch 47.',
  ...
  en: {
    ...
    legend: 'drag to tune · ◀ ▶ one notch · count the pulses in each cluster = two digits · LOG IT',
    again: 'NEXT NIGHT',

    'tip.first': 'Somewhere on the scale there is a person transmitting. Find them.',
    'tip.grammar': 'A person sends in CLUSTERS: pulses packed close and evenly spaced. Machines only tick alone.',
    'tip.count': 'Count the pulses in each cluster: the first is the first digit, the second is the second.',
    'tip.meaning': 'So 4 pulses — pause — 7 pulses = 47. Tomorrow they move to mark 47.',
