...
const DANG_NP = [
  [nb('^(has|have)\\s+been\\s+' + D + '\\w+ing$'), 'hiện tại hoàn thành tiếp diễn (has/have been + V-ing)'],
  [nb('^had\\s+been\\s+' + D + '\\w+ing$'), 'quá khứ hoàn thành tiếp diễn (had been + V-ing)'],
  [nb('^will\\s+have\\s+been\\s+' + D + '\\w+ing$'), 'tương lai hoàn thành tiếp diễn (will have been + V-ing)'],
  [nb('^will\\s+have\\s+' + D + '\\w+'), 'tương lai hoàn thành (will have + V3)'],
  [nb('^will\\s+be\\s+' + D + '\\w+ing$'), 'tương lai tiếp diễn (will be + V-ing)'],
  [nb('^(is|are|am)\\s+being\\s+' + D + '\\w+'), 'bị động tiếp diễn (is/are being + V3)'],
  [nb('^(has|have)\\s+been\\s+' + D + '\\w+'), 'bị động hoàn thành (has/have been + V3)'],
  [nb('^(has|have)\\s+' + D + '\\w+'), 'hiện tại hoàn thành (has/have + V3)'],
  [nb('^had\\s+' + D + '\\w+'), 'quá khứ hoàn thành (had + V3)'],
  [nb('^(is|are|am)\\s+going\\s+to'), 'be going to + V — dự đoán CÓ dấu hiệu trước mắt'],
  [nb('^(is|are|am)\\s+' + D + '\\w+ing$'), 'hiện tại tiếp diễn (is/are/am + V-ing)'],
  [nb('^(was|were)\\s+' + D + '\\w+ing$'), 'quá khứ tiếp diễn (was/were + V-ing)'],
  [nb('^(is|are|am)\\s+' + D + '\\w+'), 'bị động hiện tại đơn (is/are/am + V3)'],
  [nb('^(was|were)\\s+' + D + '\\w+'), 'bị động quá khứ đơn (was/were + V3)'],
  [nb('^will\\s+' + D + '\\w+'), 'tương lai đơn (will + V)'],
  [nb('^would\\s+have\\s+' + D + '\\w+'), 'would have + V3 — điều kiện loại 3'],
  [nb('^would\\s+' + D + '\\w+'), 'would + V — điều kiện loại 2'],
  [nb('^(could|might|may|should|must|can)\\s+have\\s+' + D + '\\w+'), 'khuyết thiếu + have + V3 — suy đoán về QUÁ KHỨ'],
  [nb('^(could|might|may|should|must|can|need|ought)\\b'), 'khuyết thiếu + V nguyên thể — nói về hiện tại/tương lai'],
  [nb('^to\\s+\\w+'), 'nguyên thể có "to" — thường chỉ mục đích'],
  [nb('^being\\s+\\w+'), 'being + V3 — phân từ bị động rút gọn'],
  [nb('^having\\s+\\w+'), 'having + V3 — xảy ra TRƯỚC vế chính'],
  [nb('^(who|whom|whose|which|that|where|when|why)$'), 'đại từ quan hệ']
];
TD.nghiaTuAnh = function (x) {
  ...
  const HAU_TO = [
    ...
    [/s$/, 'chia ngôi 3 số ít hoặc danh từ số nhiều']
  ];
...
const MC = (R, de, it, meo) => {
  ...
  const loai = TD.khoiLoai(opts, it.d, it.sv, TD.nghiaTuAnh);
