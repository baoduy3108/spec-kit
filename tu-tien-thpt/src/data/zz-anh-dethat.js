...
{ ten: 'GREEN CAMPUS VOLUNTEER PROGRAMME',
  ...
  { so: 2, d: 'is required', m: 2, s: ['requires', 'is requiring', 'required'],
...
{ ten: 'NOTICE — LIBRARY OPENING HOURS',
  ...
  { so: 3, d: 'be returned', m: 2, s: ['return', 'be returning', 'have returned'],
...
{ ten: 'EMAIL — SCHOOL TRIP CONFIRMATION',
  ...
  cho: [
  { so: 1, d: 'which', m: 1, s: ['who', 'where', 'whose'],
...
{ ten: 'FLYER — CITY MARATHON 2026',
  ...
  cho: [
  { so: 1, d: 'is open', m: 2, s: ['opens', 'has opened', 'is opening'],
  ...
  { so: 4, d: 'that', m: 1, s: ['who', 'what', 'where'],
...
{ ten: 'ANNOUNCEMENT — SCHOOL CLUB FAIR',
  ...
  cho: [
  { so: 1, d: 'will be held', m: 2, s: ['will hold', 'is holding', 'held'],
...
{ ten: 'NOTICE — RECYCLING RULES IN THE DORMITORY',
  ...
  { so: 2, d: 'while', m: 2, s: ['so', 'because', 'unless'],
...
{ ten: 'ADVERTISEMENT — ONLINE ENGLISH COURSE',
  ...
  { so: 2, d: 'who', m: 2, s: ['which', 'whom', 'whose'],
    ...
    sv: { which: 'chỉ dùng cho vật',
          ...
          whose: 'chỉ sở hữu, phải có danh từ theo sau' } },
  { so: 3, d: 'is taught', m: 2, s: ['teaches', 'is teaching', 'teaching'],
