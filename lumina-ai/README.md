...
| 🤖 **Agent tùy chỉnh** | Sidebar → **🤖 Agent của tôi**: có sẵn **⚙️ Lumina Forge** (kỹ sư cấp cao), và **＋** để tự tạo agent riêng (tên + emoji + hướng dẫn/tính cách). Bấm agent → mở workspace kiểu Claude Code: xem/tạo **session** riêng của agent. Mọi câu chat làm theo hướng dẫn agent **và tự áp dụng thư viện kỹ năng nội bộ** (ngầm, không lộ ra người dùng) | Lưu theo tài khoản; hướng dẫn + kỹ năng khớp chèn ngầm vào system prompt |
