...
**🧠 Workflow tự tiến hoá (học theo thời gian):** LUMINA **không đứng yên** — mỗi lượt chat, nó (1) tra **kho tri thức nội bộ** trước (0 token), thiếu thì **tự học** từ Wikipedia rồi **lưu lại** để lần sau dùng ngay; (2) áp dụng **kỹ năng chuyên môn** khớp từ thư viện 669+ skill; (3) **nhớ hội thoại cũ** của bạn. Kho tri thức **lớn dần theo thời gian sử dụng**. **Dạy LUMINA:** gõ mệnh lệnh như *"ghi nhớ rằng dự án X của tôi dùng cổng 8842"* → LUMINA **tiếp thu** vào kho (chip "🧠 Đã tiếp thu & ghi nhớ") và **tra lại được ở các lượt sau** — workflow tiến hoá theo đúng kiến thức **bạn** cung cấp. *(Lưu ý thật: đây là học ở tầng HỆ THỐNG — kho tri thức + trí nhớ + skills lớn dần; KHÔNG phải fine-tune đổi trọng số model. Model nền vẫn vậy, nhưng ngữ cảnh/tri thức LUMINA đưa vào ngày càng giàu.)*
