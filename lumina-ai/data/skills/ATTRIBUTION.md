...
| `GanyuanRan/Aegis` (2 skill: first-principles-review, goal-framing — phần lớn repo là fork superpowers đã có sẵn, chỉ lấy 2 skill phương pháp riêng biệt) | GanyuanRan | MIT | https://github.com/GanyuanRan/Aegis |
