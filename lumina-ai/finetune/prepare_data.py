...
SOURCES = {
    ...
    "flan":       ("SirNeural/flan_v2", None, "train", _aya, "FLAN v2 (Google, đa tác vụ kinh điển); mirror LỚN — dùng streaming + max-per-source"),
    "tulu2":      ("allenai/tulu-v2-sft-mixture", None, "train", _ultrachat, "ODC-BY; hỗn hợp nhiều SFT chất lượng (đã gồm subset FLAN)"),
